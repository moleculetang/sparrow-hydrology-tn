...
RAW_DEFAULT = ROOT / "0_reach_topology" / "data" / "raw" / "atmosphere" / "precipitation" / "chm_pre_v2" / "monthly" / "CHM_PRE_V2_monthly.nc"
...
def build_grid_mapping(nc_path: Path, out_dir: Path) -> pd.DataFrame:
...
def main() -> None:
    ...
    if args.reuse_mapping and mapping_path.exists():
        ...
        mapping = build_grid_mapping(args.nc, args.out_dir)
