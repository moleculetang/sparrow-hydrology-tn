...
def main() -> None:
    ...
    lines = [
        "# 20260603_5 empirical-Bayes weighted hydrologic Q run and validation diagnostics",
        "",
        "This run reuses the 20260603_4 length-extended PRB Q input, then applies empirical-Bayes station likelihood weights",
        "inside SPARROW parameter estimation. The source/storage equation is unchanged; only `ls_weight` changes.",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_5 empirical-Bayes station-weighted MAP-like run reused 20260603_4 input and source/storage Q structure, "
