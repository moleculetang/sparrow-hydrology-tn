...
RUN_DIR = ROOT / "5_Test" / "20260603_8"
...
def main() -> None:
    ...
    lines = [
        "# 20260603_8 explicit-reservoir source/storage Q run and validation diagnostics",
        "",
        "This run reuses the 20260603_5 empirical-Bayes station weights, then adds explicit reservoir mechanism variables",
        "`res_decay` and `res_lag` inside the source/storage Q equation.",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_8 explicit-reservoir run reused 20260603_5 weights and added reservoir res_decay/res_lag source-storage terms, "
