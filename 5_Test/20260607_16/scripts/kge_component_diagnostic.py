...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12_13_14_15_16.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12_13_14_15_16.csv", index=False, encoding="utf-8-sig")
    ...
    for station in wide.index:
        ...
        for comp in ["r", "alpha", "beta", "KGE_2012"]:
            for candidate in ["20260607_8", "20260607_9", "20260607_10", "20260607_11", "20260607_12", "20260607_13", "20260607_14", "20260607_15", "20260607_16"]:
                row[f"delta_{comp}_{candidate}_minus_5"] = wide.loc[station, (comp, candidate)] - wide.loc[
                    station, (comp, "20260607_5")
                ]
        delta_rows.append(row)
    delta = pd.DataFrame(delta_rows)
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_13_14_15_16_vs_5.csv", index=False, encoding="utf-8-sig")

    md_lines = [
        "# KGE Component Diagnosis",
        "",
        "Strict validation period: 2019-2022 only. The first diagnostic pass compared 20260607_5, 20260607_8, and 20260607_9; after 20260607_10 was run this file was refreshed to include the flow-duration contrast model.",
        "",
        ...
        "## Interpretation",
        "",
        "The SAS branch improves or preserves temporal correlation, and bias ratio is not the main loss. "
        "The key degradation relative to 20260607_5 is variability ratio: 20260607_9 has a lower median alpha "
        "and more stations with |alpha-1| > 0.25. Therefore 20260607_10 should target amplitude/flow-duration "
        "contrast at the parameter-fitting level, not add another small SAS storage tweak.",
    ]
