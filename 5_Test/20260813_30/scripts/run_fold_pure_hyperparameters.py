...
SCENARIOS = {
    ...
    "P1": {"scale": 1.0, "semantics": "d8_supported_catchments_fold_pure_hysteresis_selection", "repair": True, "fold_pure_hysteresis": True},
}
...
def main() -> None:
    ...
    if args.scenario in {"P1", "all"}:
        # This directory is an authorized engineering-input repair.  Exact
        # reproduction of the old-input P0 is neither expected nor meaningful;
        # the immutable key/observed/fold comparison is performed after P1.
