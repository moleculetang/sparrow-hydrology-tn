...
RUN_DIR = ROOT / "5_Test" / "20260603_9"
...
def main() -> None:
    ...
    lines = [
        "# 20260603_9 downstream-reservoir-influence Q run and validation diagnostics",
        "",
        "This run extends 20260603_8 by applying `res_decay` and `res_lag` to all reaches downstream of named reservoir reaches,",
        "so reservoir regulation can propagate through the river network.",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_9 downstream-reservoir-influence run applied res_decay/res_lag to named reservoir reaches and all downstream reaches, "
