...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12_13_14_15_16_17_18.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12_13_14_15_16_17_18.csv", index=False, encoding="utf-8-sig")
    ...
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_13_14_15_16_17_18_vs_5.csv", index=False, encoding="utf-8-sig")

    md_lines = [
        "# KGE Component Diagnosis",
        "",
        "Strict validation period: 2019-2022 only. This refresh includes the 20260607_18 station mean-anomaly amplitude-gain model.",
        "",
