"""Pre-registered settings for the 20260727_15 disconnection-threshold experiment."""
...
# The only fitted-model change in this run. The threshold is fixed before
# execution and is not selected with 2019-2022 observations.
SLOW_FLOW_DISCONNECTION_THRESHOLD_FRACTION = 0.25
