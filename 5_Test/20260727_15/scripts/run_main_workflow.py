...
from experiment_settings import SLOW_FLOW_DISCONNECTION_THRESHOLD_FRACTION
...
HYPERPARAMS = (
    ...
    f"flow_contrast_weight=1.0;slow_flow_disconnection_threshold_fraction="
    f"{SLOW_FLOW_DISCONNECTION_THRESHOLD_FRACTION}"
)
