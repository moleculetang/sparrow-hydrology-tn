...
STEPS = [
    ...
    (
        "stage2_disconnection_threshold_diagnostics",
        "build_stage2_disconnection_threshold_diagnostics.py",
    ),
    (
        "stage2_disconnection_threshold_gate",
        "compare_stage2_disconnection_threshold.py",
    ),
]
