...
RAW_DEFAULT = ROOT / "0_reach_topology" / "data" / "raw" / "CMFD"
OUT_DEFAULT = ROOT / "0_reach_topology" / "data" / "processed" / "cmfd_prb"

sys.path.insert(0, str(SCRIPT_DIR))
from process_chm_pre_v2_corrected import (  # noqa: E402
...
def build_grid_mapping(raw_dir: Path, out_dir: Path, catchments_path: Path) -> pd.DataFrame:
...
def main() -> None:
    ...
    if args.reuse_mapping and mapping_path.exists():
        ...
        mapping = build_grid_mapping(args.raw_dir, args.out_dir, args.catchments)
