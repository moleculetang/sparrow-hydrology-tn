...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27.csv", index=False, encoding="utf-8-sig")
    ...
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27_vs_5.csv", index=False, encoding="utf-8-sig")

    md_lines = [
        "# KGE Component Diagnosis",
        "",
        "Strict validation period: 2019-2022 only. This refresh includes the 20260607_27 production-routing Bayesian model with conservation prior.",
        "",
        ...
        "## Interpretation",
        "",
        "The main question tested by 20260607_27 is whether a routed mass-balance prior helps the richer production-routing Bayesian equation. "
        "Use the summary and station deltas to compare 20260607_27 against 20260607_19, 20260607_26, and the balanced 20260607_5 candidate.",
    ]
