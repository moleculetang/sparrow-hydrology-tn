...
def write_reports(indata: pd.DataFrame, reach: pd.DataFrame, topo: pd.DataFrame, discharge_m: pd.DataFrame, station_match: pd.DataFrame) -> None:
    ...
    summary = [
        ...
        "- 北流站、官良站、平山（三）站、犁市（二）站 are excluded from this active calibration input build because their observations or station-reach representativeness are under question.",
...
- 北流站、官良站、平山（三）站、犁市（二）站 are excluded before station matching and model training as suspected observation/representativeness problem stations.
...
def main() -> int:
    ...
    log = [
        ...
        "北流站、官良站、平山（三）站、犁市（二）站 were excluded from the active calibration input table before station matching and model training.",
