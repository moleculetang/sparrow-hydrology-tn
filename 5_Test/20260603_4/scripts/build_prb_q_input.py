...
def write_reports(indata: pd.DataFrame, reach: pd.DataFrame, topo: pd.DataFrame, discharge_q: pd.DataFrame, station_match: pd.DataFrame) -> None:
    ...
    summary = [
        "# 20260603_4 PRB Q input build summary",
        "",
        "## Source boundary",
        ...
        "- New files were written only under `E:/SPARROW/5_Test/20260603_4`.",
        "",
        "## Counts",
        f"- reaches: {len(reach)}",
        ...
        "- same-reach multi-station conflicts were resolved by selecting one station per reach using usable quarters, usable years, snap distance, and station name.",
        "",
        "## Climate inputs",
...
def write_readme() -> None:
    text = """# 20260603_4 PRB Q input build
...
- Same-reach multi-station conflicts are handled by selecting one station per reach using data coverage and snap distance.
...
conda --no-plugins run -n sparrow python E:/SPARROW/run_sparrow.py --config E:/SPARROW/5_Test/20260603_4/prb_q_config.py
...
def main() -> int:
    ...
    log = [
        "# 20260603_4 run log",
        "",
        "Built PRB Q input table from existing topology results, complete 2010-2022 discharge, and monthly mean 2006-2009 discharge converted to quarterly observations.",
        "Same-reach multiple stations were resolved by selecting the highest-coverage/closest station for each reach.",
