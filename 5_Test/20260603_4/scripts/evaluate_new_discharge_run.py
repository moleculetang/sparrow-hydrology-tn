...
def main() -> None:
    ...
    lines = [
        "# 20260603_4 length-extended hydrologic Q run and validation diagnostics",
        "",
        "This run rebuilds the PRB Q input using complete 2010-2022 discharge plus the 2006-2009 monthly mean workbook, runs the",
        "native SPARROW Python runtime once with a more original-like Q source/storage structure, then evaluates the validation-period rows",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_4 rebuilt input from complete_2010_2022 plus monthly_mean_2006_2009, used one selected station per same-reach group, ran SPARROW once with storage-enabled Q source structure, "
