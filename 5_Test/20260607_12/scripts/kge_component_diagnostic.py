...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12.csv", index=False, encoding="utf-8-sig")
    ...
    for station in wide.index:
        ...
        for comp in ["r", "alpha", "beta", "KGE_2012"]:
            for candidate in ["20260607_8", "20260607_9", "20260607_10", "20260607_11", "20260607_12"]:
                row[f"delta_{comp}_{candidate}_minus_5"] = wide.loc[station, (comp, candidate)] - wide.loc[
                    station, (comp, "20260607_5")
                ]
        delta_rows.append(row)
    delta = pd.DataFrame(delta_rows)
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_vs_5.csv", index=False, encoding="utf-8-sig")
