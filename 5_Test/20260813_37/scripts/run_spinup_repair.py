...
COMPONENT = ROOT / "scripts" / "components" / "q72_spinup_audit_component.py"
...
SCENARIOS = {
    "W1": {
        "scale": 1.0,
        "semantics": "d8_supported_reach193_repair_periodic_2006_2011_spinup",
        "repair": True,
...
def main() -> None:
    ...
    parser.add_argument("scenario", choices=["W1"])
    args = parser.parse_args()
    payload: dict[str, object] = {"W1": assemble("W1")}
