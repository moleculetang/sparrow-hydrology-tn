...
def write_readme() -> None:
    ...
    text = f"""# {RUN_DIR.name} Dynamic Station-Screening Run

This is one sequential experiment in the dynamic non-reservoir station-screening chain. It rebuilds the Pearl River Basin Q model from source data using the `20260620_44` model structure and hyperparameters.
...
- The authoritative plan is `../20260721_1/DYNAMIC_STATION_SCREENING_PLAN.md`.
