...
def main() -> None:
    ...
    validation = resids[resids["period"].between(48, 52)].copy()
    ...
    lines = [
        "# 20260603_1 complete-discharge native SPARROW run and validation diagnostics",
        "",
        "This run rebuilds the PRB Q input using `E:/SPARROW/1_Inputs/DischargeData/complete_2010_2022`, runs the",
        "native SPARROW Python runtime once, then evaluates the validation-period rows",
        "`2021Q4-2022Q4` (`period` 48-52).",
        "",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_1 rebuilt input from 1_Inputs/DischargeData/complete_2010_2022, ran native SPARROW once, "
