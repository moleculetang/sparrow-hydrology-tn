"""Zero-target-history terminal-tree fold for the nested conserving DYN2P model."""
...
class TwoPathCandidate(torch.nn.Module):
    def __init__(self, seed: int) -> None:
        ...
        self.raw_channel_strength = None
