...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25.csv", index=False, encoding="utf-8-sig")
    ...
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_vs_5.csv", index=False, encoding="utf-8-sig")

    md_lines = [
        "# KGE Component Diagnosis",
        "",
        "Strict validation period: 2019-2022 only. This refresh includes the 20260607_25 constrained network mass-balance model.",
        "",
        ...
        "## Interpretation",
        "",
        "The main question tested by 20260607_25 is whether a strict nonnegative routed mass-balance model can replace the station-level Bayesian parameter hierarchy. "
        "Use the summary and station deltas to compare 20260607_25 against 20260607_19, 20260607_24, and the balanced 20260607_5 candidate.",
    ]
