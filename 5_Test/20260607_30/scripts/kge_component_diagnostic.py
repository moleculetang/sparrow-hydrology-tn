...
RUN_FILES = {
    ...
    "20260607_22": TEST_ROOT
    / "20260607_22"
    / "reports"
    / "monthly_bayes_station_normalized_response_prediction_vs_observed_2006_2022.csv",
    "20260607_23": TEST_ROOT
    / "20260607_23"
    / "reports"
    / "monthly_bayes_power_flow_target_prediction_vs_observed_2006_2022.csv",
    "20260607_24": TEST_ROOT
    / "20260607_24"
    / "reports"
    / "monthly_bayes_network_accumulation_prediction_vs_observed_2006_2022.csv",
    "20260607_25": TEST_ROOT
    / "20260607_25"
    / "reports"
    / "monthly_constrained_mass_balance_prediction_vs_observed_2006_2022.csv",
    "20260607_26": TEST_ROOT
    / "20260607_26"
    / "reports"
    / "monthly_mass_balance_hierarchical_gain_prediction_vs_observed_2006_2022.csv",
    "20260607_27": TEST_ROOT
    / "20260607_27"
    / "reports"
    / "monthly_bayes_production_conservation_prior_prediction_vs_observed_2006_2022.csv",
    "20260607_28": TEST_ROOT
    / "20260607_28"
    / "reports"
    / "monthly_bayes_spatial_group_response_prediction_vs_observed_2006_2022.csv",
    "20260607_29": TEST_ROOT
    / "20260607_29"
    / "reports"
    / "monthly_bayes_spatial_multistore_prediction_vs_observed_2006_2022.csv",
    "20260607_30": TEST_ROOT
    / "20260607_30"
    / "reports"
...
def main() -> None:
    ...
    detail.to_csv(REPORT_DIR / "kge_component_by_station_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27_28_29_30.csv", index=False, encoding="utf-8-sig")
    ...
    summary.to_csv(REPORT_DIR / "kge_component_summary_20260607_5_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27_28_29_30.csv", index=False, encoding="utf-8-sig")
    ...
    delta.to_csv(REPORT_DIR / "kge_component_delta_20260607_8_9_10_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_26_27_28_29_30_vs_5.csv", index=False, encoding="utf-8-sig")

    md_lines = [
        "# KGE Component Diagnosis",
        "",
        "Strict validation period: 2019-2022 only. This refresh includes the 20260607_30 seasonal hysteresis Bayesian model.",
        "",
        ...
        "## Interpretation",
        "",
        "The main question tested by 20260607_30 is whether seasonal rising-limb/recession hysteresis states can reduce the amplitude and seasonal phase bottleneck while preserving the spatial-group production-routing gains. "
        "Use the summary and station deltas to compare 20260607_30 against 20260607_29, 20260607_28, 20260607_19, 20260607_12, and the balanced 20260607_5 candidate.",
    ]
