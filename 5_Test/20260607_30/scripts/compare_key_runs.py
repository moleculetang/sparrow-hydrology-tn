...
RUN_FILES = {
    ...
    "20260607_12": {
        "summary": "monthly_bayes_season_regime_slopes_metric_summary.csv",
        "metrics": "monthly_bayes_season_regime_slopes_metrics_by_station.csv",
    },
    "20260607_13": {
        "summary": "monthly_bayes_amplitude_gain_metric_summary.csv",
        "metrics": "monthly_bayes_amplitude_gain_metrics_by_station.csv",
    },
    "20260607_14": {
        "summary": "monthly_bayes_crossborder_season_regime_metric_summary.csv",
        "metrics": "monthly_bayes_crossborder_season_regime_metrics_by_station.csv",
    },
    "20260607_15": {
        "summary": "monthly_bayes_local_crossborder_metric_summary.csv",
        "metrics": "monthly_bayes_local_crossborder_metrics_by_station.csv",
    },
    "20260607_16": {
        "summary": "monthly_bayes_reservoir_season_regime_metric_summary.csv",
        "metrics": "monthly_bayes_reservoir_season_regime_metrics_by_station.csv",
    },
    "20260607_17": {
        "summary": "monthly_bayes_reservoir_crossborder_season_regime_metric_summary.csv",
        "metrics": "monthly_bayes_reservoir_crossborder_season_regime_metrics_by_station.csv",
    },
    "20260607_18": {
        "summary": "monthly_bayes_mean_anomaly_gain_metric_summary.csv",
        "metrics": "monthly_bayes_mean_anomaly_gain_metrics_by_station.csv",
    },
    "20260607_19": {
        "summary": "monthly_bayes_production_routing_metric_summary.csv",
        "metrics": "monthly_bayes_production_routing_metrics_by_station.csv",
    },
    "20260607_20": {
        "summary": "monthly_bayes_production_anomaly_objective_metric_summary.csv",
        "metrics": "monthly_bayes_production_anomaly_objective_metrics_by_station.csv",
    },
    "20260607_21": {
        "summary": "monthly_bayes_gated_production_routing_metric_summary.csv",
        "metrics": "monthly_bayes_gated_production_routing_metrics_by_station.csv",
    },
    "20260607_22": {
        "summary": "monthly_bayes_station_normalized_response_metric_summary.csv",
        "metrics": "monthly_bayes_station_normalized_response_metrics_by_station.csv",
    },
    "20260607_23": {
        "summary": "monthly_bayes_power_flow_target_metric_summary.csv",
        "metrics": "monthly_bayes_power_flow_target_metrics_by_station.csv",
    },
    "20260607_24": {
        "summary": "monthly_bayes_network_accumulation_metric_summary.csv",
        "metrics": "monthly_bayes_network_accumulation_metrics_by_station.csv",
    },
    "20260607_25": {
        "summary": "monthly_constrained_mass_balance_metric_summary.csv",
        "metrics": "monthly_constrained_mass_balance_metrics_by_station.csv",
    },
    "20260607_26": {
        "summary": "monthly_mass_balance_hierarchical_gain_metric_summary.csv",
        "metrics": "monthly_mass_balance_hierarchical_gain_metrics_by_station.csv",
    },
    "20260607_27": {
        "summary": "monthly_bayes_production_conservation_prior_metric_summary.csv",
        "metrics": "monthly_bayes_production_conservation_prior_metrics_by_station.csv",
    },
    "20260607_28": {
        "summary": "monthly_bayes_spatial_group_response_metric_summary.csv",
        "metrics": "monthly_bayes_spatial_group_response_metrics_by_station.csv",
    },
    "20260607_29": {
        "summary": "monthly_bayes_spatial_multistore_metric_summary.csv",
        "metrics": "monthly_bayes_spatial_multistore_metrics_by_station.csv",
    },
    "20260607_30": {
        "summary": "monthly_bayes_seasonal_hysteresis_metric_summary.csv",
        "metrics": "monthly_bayes_seasonal_hysteresis_metrics_by_station.csv",
    },
}
...
def main() -> None:
    ...
    candidate = load_metrics("20260607_30")
    failure = pd.read_csv(REPORT_DIR / "failure_taxonomy.csv")
    delta_rows = []
    group_rows = []
    for reference_id in [run_id for run_id in RUN_FILES if run_id != "20260607_30"]:
        reference = load_metrics(reference_id)
        delta = station_delta(reference, candidate, reference_id)
        delta.to_csv(REPORT_DIR / f"seasonal_hysteresis_vs_{reference_id}_station_delta.csv", index=False, encoding="utf-8-sig")
    ...
    delta_summary.to_csv(REPORT_DIR / "seasonal_hysteresis_delta_summary.csv", index=False, encoding="utf-8-sig")
    pd.concat(group_rows, ignore_index=True).to_csv(
        REPORT_DIR / "seasonal_hysteresis_group_delta_summary.csv", index=False, encoding="utf-8-sig"
    )
