...
LOG_PATH = ROOT / "5_Test" / "20260601.log"
EPS = 1.0e-6
...
def main() -> None:
    ...
    lines = [
        "# 20260601_1 Complete-discharge native run and validation diagnostics",
        "",
        "This run rebuilds the PRB Q input using `E:/SPARROW/1_Inputs/DischargeData`, runs the",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-01] 20260601_1 rebuilt input from 1_Inputs/DischargeData, ran native SPARROW once, "
