...
def attach_gate_and_time(
    ...
    result["time_gate"] = sigmoid((numerator / denominator).to_numpy(dtype=float))
...
def main() -> None:
    ...
    elif time_gate_breadth_diagnosed:
        decision = "target_improves_but_time_gate_too_broad"
        next_action = "one_bounded_time_gate_sharpening_iteration"
    else:
        decision = "minimal_pilot_failed_contract"
        next_action = "evidence_stop_unless_one_contract_internal_mechanism_is_diagnosed"
