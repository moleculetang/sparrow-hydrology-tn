...
MODEL = (
    RUN / "outputs" / "storage_heterogeneity_recharge_reach_month.parquet"
)
CONTROL = (
    RUN / "outputs" / "reach_heterogeneity_reordered_vertical_share.parquet"
)
FIXED_EXCLUSIONS = {
...
def main() -> None:
    ...
    checks = {
        ...
        "two_scenarios": set(metrics["scenario"]) == {
            "current_combined", "heterogeneity_reordered"
        },
        "station_rows_97": (
