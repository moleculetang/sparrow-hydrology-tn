...
SCENARIOS = {
    "A1": {
        "scale": 1.0,
        "semantics": "d8_supported_catchments_fold_pure_hysteresis_reach193_representative_repair",
        "repair": True,
...
def main() -> None:
    ...
    parser.add_argument("scenario", choices=["A1"])
    args = parser.parse_args()
    payload: dict[str, object] = {"A1": assemble("A1")}
