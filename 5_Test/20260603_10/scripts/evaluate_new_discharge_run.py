...
RUN_DIR = ROOT / "5_Test" / "20260603_10"
...
def main() -> None:
    ...
    lines = [
        "# 20260603_10 distance-limited reservoir Q run and validation diagnostics",
        "",
        "This run extends 20260603_9 by replacing all-downstream reservoir propagation with a distance-limited hydrologic prior:",
        "named reservoir reaches receive strength 1.0, first downstream reaches 0.45, second downstream reaches 0.20, and farther downstream reaches 0.",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-03] 20260603_10 distance-limited reservoir run applied res_decay/res_lag with strengths reservoir=1.0, downstream1=0.45, downstream2=0.20, "
