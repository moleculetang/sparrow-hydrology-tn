...
RUN_DIR = ROOT / "5_Test" / "20260604_1"
...
def main() -> None:
    ...
    lines = [
        "# 20260604_1 strict geographic station-reach correction Q run diagnostics",
        "",
        "This run rebuilds the clean split reservoir-body/downstream mechanism from 20260603_11, but changes station-reach matching.",
        ...
        "Station-reach matching uses nearest reach-line geometry first, with catchment containment retained for audit; same-reach conflicts then use the topology-plausible significant-station rule.",
    ...
    with LOG_PATH.open("a", encoding="utf-8") as fh:
        fh.write(
            "\n[2026-06-04] 20260604_1 rebuilt the clean split reservoir-body/downstream run using strict geographic station-reach corrections plus topology-plausible significant same-reach station selection, "
