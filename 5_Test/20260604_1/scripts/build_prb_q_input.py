...
def write_reports(indata: pd.DataFrame, reach: pd.DataFrame, topo: pd.DataFrame, discharge_q: pd.DataFrame, station_match: pd.DataFrame) -> None:
    ...
    summary = [
        "# 20260604_1 PRB Q input build summary",
        "",
        "## Source boundary",
        ...
        "- New files were written only under `E:/SPARROW/5_Test/20260604_1`.",
        "",
        "## Counts",
        f"- reaches: {len(reach)}",
...
def write_readme() -> None:
    text = """# 20260604_1 PRB Q input build
...
conda --no-plugins run -n sparrow python E:/SPARROW/run_sparrow.py --config E:/SPARROW/5_Test/20260604_1/prb_q_config.py
